...
public:
   // sec:expr
    ...
    static int index, ops, query_num, series_num, k, visited_node_num;
    static double search_ratio;
    ...
    static double fuzzy_f_1st, fuzzy_f, alpha_1st, alpha;
    ...
    static void readConfig(){
        ...
        alpha_1st = reader.GetReal("parameter", "alpha_1st", 0.8);
        cout << "filling_factor_1st: " << alpha_1st << endl;

        alpha = reader.GetReal("parameter", "alpha", 0.5);
        cout << "filling_factor: " << alpha << endl;
